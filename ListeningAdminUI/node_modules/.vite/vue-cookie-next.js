import {
  inject
} from "./chunk-K6BGGP4E.js";
import "./chunk-IHTDASF6.js";

// node_modules/vue-cookie-next/dist/vue-cookie-next.esm-bundler.js
var defaultConfig = {
  expire: "1d",
  path: "; path=/",
  domain: "",
...
var VueCookieNext = {
  ...
  setCookie: function(keyName, value, options) {
    ...
    var _expires = "";
    expireTimes = expireTimes === void 0 ? defaultConfig.expire : expireTimes;
    ...
    document.cookie = encodeURIComponent(keyName) + "=" + encodeURIComponent(value) + _expires + (domain ? "; domain=" + domain : defaultConfig.domain) + (path ? "; path=" + path : defaultConfig.path) + (secure === void 0 ? defaultConfig.secure : secure ? "; Secure" : "") + (sameSite === void 0 ? defaultConfig.sameSite : sameSite ? "; SameSite=" + sameSite : "");
    return this;
  },
  removeCookie: function(keyName, options) {
    ...
    document.cookie = encodeURIComponent(keyName) + "=; expires=Thu, 01 Jan 1970 00:00:00 GMT" + (domain ? "; domain=" + domain : defaultConfig.domain) + (path ? "; path=" + path : defaultConfig.path) + "; SameSite=Lax";
    return this;
  },
...
/*!
  ...
  * @license MIT
  */
//# sourceMappingURL=vue-cookie-next.js.map
